...
#httpsstackoverflow.comquestions39481221convert-datetime-back-to-windows-64-bit-filetime
WINDOWS_TICKS = int(110-7)  # 10,000,000 (100 nanoseconds or .1 microseconds)
WINDOWS_EPOCH = datetime.datetime.strptime('1601-01-01 000000',
                                           '%Y-%m-%d %H%M%S')
POSIX_EPOCH = datetime.datetime.strptime('1970-01-01 000000',
                                         '%Y-%m-%d %H%M%S')
...
for i in range(num_results):
	...
	print(ctypes.wstring_at(filename),get_time(date_modified_filetime),file_size.value)
